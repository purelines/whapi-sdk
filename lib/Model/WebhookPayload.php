...
class WebhookPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'messages_updates' => '\OpenAPI\Client\Model\MessageUpdate[]',
        'messages_removed' => 'string[]',
        'messages_removed_all' => 'string',
        'statuses' => '\OpenAPI\Client\Model\Status[]',
        'chats' => '\OpenAPI\Client\Model\Chat[]',
        'chats_updates' => '\OpenAPI\Client\Model\ChatUpdate[]',
        'chats_removed' => 'string[]',
        'contacts_updates' => '\OpenAPI\Client\Model\ContactUpdate[]',
        'groups' => '\OpenAPI\Client\Model\Group[]',
        'groups_participants' => '\OpenAPI\Client\Model\ParticipantEvent[]',
        'groups_updates' => '\OpenAPI\Client\Model\GroupUpdate[]',
        'presences' => '\OpenAPI\Client\Model\Presence[]',
        'labels' => '\OpenAPI\Client\Model\Label[]',
        'labels_removed' => 'string[]',
        'calls' => '\OpenAPI\Client\Model\CallEvent[]',
        'qr' => '\OpenAPI\Client\Model\QR',
    ...
    */
     ...
     * Sets contacts
     *
     * @param \OpenAPI\Client\Model\Contact[]|null $contacts The contacts array contains all contacts that were sent to the webhook URL. Sent on event \"contacts.post\"
     *
     * @return self
     */
     ...
     * Sets messages
     *
     * @param \OpenAPI\Client\Model\Message[]|null $messages The messages array contains all messages that were sent to the webhook URL. Sent on event \"messages.post\" or \"messages.put\"
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\MessageUpdate[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\MessageUpdate[]|null $messages_updates The messages updates array contains all messages updates that were sent to the webhook URL. Sent on event \"messages.patch\"
     *
     * @return self
     */
     ...
     * Sets statuses
     *
     * @param \OpenAPI\Client\Model\Status[]|null $statuses The messages statuses array contains all statuses that were sent to the webhook URL. Sent on event \"statuses.post\" or \"statuses.put\"
     *
     * @return self
     */
     ...
     * Sets chats
     *
     * @param \OpenAPI\Client\Model\Chat[]|null $chats The chats array contains all chats that were sent to the webhook URL. Sent on event \"chats.post\" or \"chats.put\"
     *
     * @return self
     */
     ...
     * Gets chats_updates
     *
     * @return \OpenAPI\Client\Model\ChatUpdate[]|null
     */
     ...
     * Sets chats_updates
     *
     * @param \OpenAPI\Client\Model\ChatUpdate[]|null $chats_updates The chats updates array contains all chats updates that were sent to the webhook URL. Sent on event \"chats.patch\"
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ContactUpdate[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ContactUpdate[]|null $contacts_updates The contacts updates array contains all contacts updates that were sent to the webhook URL. Sent on event \"contacts.patch\"
     *
     * @return self
     */
     ...
     * Sets groups
     *
     * @param \OpenAPI\Client\Model\Group[]|null $groups The groups array contains all groups that were sent to the webhook URL. Sent on event \"groups.post\"
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ParticipantEvent[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ParticipantEvent[]|null $groups_participants The groups participants event array contains all groups participants event that were sent to the webhook URL. Sent on event \"groups.put\"
     *
     * @return self
     */
     ...
     * Gets groups_updates
     *
     * @return \OpenAPI\Client\Model\GroupUpdate[]|null
     */
     ...
     * Sets groups_updates
     *
     * @param \OpenAPI\Client\Model\GroupUpdate[]|null $groups_updates The groups updates array contains all groups updates that were sent to the webhook URL. Sent on event \"groups.patch\"
     *
     * @return self
     */
     ...
     * Gets presences
     *
     * @return \OpenAPI\Client\Model\Presence[]|null
     */
     ...
     * Sets presences
     *
     * @param \OpenAPI\Client\Model\Presence[]|null $presences The presences array contains all presences that were sent to the webhook URL. Sent on event \"presences.post\"
     *
     * @return self
     */
     ...
     * Sets labels
     *
     * @param \OpenAPI\Client\Model\Label[]|null $labels The labels array contains all labels that were sent to the webhook URL. Sent on event \"labels.post\"
     *
     * @return self
     */
     ...
     * Gets calls
     *
     * @return \OpenAPI\Client\Model\CallEvent[]|null
     */
     ...
     * Sets calls
     *
     * @param \OpenAPI\Client\Model\CallEvent[]|null $calls The calls array contains all calls that were sent to the webhook URL. Sent on event \"calls.post\"
     *
     * @return self
     */
     ...
     * Gets qr
     *
     * @return \OpenAPI\Client\Model\QR|null
     */
     ...
     * Sets qr
     *
     * @param \OpenAPI\Client\Model\QR|null $qr qr
     *
     * @return self
     */
