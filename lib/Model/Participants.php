...
/**
 * Participants Class Doc Comment
 *
 * @category Class
 * @package  Purelines\WhapiSdk
 * @author   OpenAPI Generator team
 ...
 */
class Participants implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Participants';
    ...
    */
    ...
    public function setParticipants($participants)
    {
        ...
        if ((count($participants) < 1)) {
            throw new \InvalidArgumentException('invalid length for $participants when calling Participants., number of items must be greater than or equal to 1.');
        }
