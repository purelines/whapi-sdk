...
/**
 * CreateGroupInCommunityRequest Class Doc Comment
 *
 * @category Class
 * @package  Purelines\WhapiSdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateGroupInCommunityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateGroupInCommunityRequest';
    ...
    */
    ...
    public function setParticipants($participants)
    {
        ...
        if ((count($participants) < 1)) {
            throw new \InvalidArgumentException('invalid length for $participants when calling CreateGroupInCommunityRequest., number of items must be greater than or equal to 1.');
        }
