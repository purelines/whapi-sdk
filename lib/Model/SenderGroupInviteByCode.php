...
/**
 * SenderGroupInviteByCode Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SenderGroupInviteByCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SenderGroupInviteByCode';
    ...
    public const PREVIEW_TYPE_GROUP_PICTURE = 'group_picture';
    ...
    {
        return [
            self::PREVIEW_TYPE_GROUP_PICTURE,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('preview_type', $data ?? [], 'group_picture');
    ...
    */
    ...
    public function setTo($to)
    {
        ...
        if ((!preg_match("/^[\\d-]{10,31}(@[\\w\\.]{1,})?$/", ObjectSerializer::toString($to)))) {
            throw new \InvalidArgumentException("invalid value for \$to when calling SenderGroupInviteByCode., must conform to the pattern /^[\\d-]{10,31}(@[\\w\\.]{1,})?$/.");
        }
    ...
    public function setQuoted($quoted)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9._]{4,23}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{4,10})?$/", ObjectSerializer::toString($quoted)))) {
            throw new \InvalidArgumentException("invalid value for \$quoted when calling SenderGroupInviteByCode., must conform to the pattern /^[A-Za-z0-9._]{4,23}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{4,10})?$/.");
        }
    ...
    public function setEphemeral($ephemeral)
    {
        ...
        if (($ephemeral > 604800)) {
            throw new \InvalidArgumentException('invalid value for $ephemeral when calling SenderGroupInviteByCode., must be smaller than or equal to 604800.');
        }
        if (($ephemeral < 1)) {
            throw new \InvalidArgumentException('invalid value for $ephemeral when calling SenderGroupInviteByCode., must be bigger than or equal to 1.');
        }
    ...
    public function setEdit($edit)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9._]{4,23}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{4,10})?$/", ObjectSerializer::toString($edit)))) {
            throw new \InvalidArgumentException("invalid value for \$edit when calling SenderGroupInviteByCode., must conform to the pattern /^[A-Za-z0-9._]{4,23}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{4,10})?$/.");
        }
     ...
     * Sets title
     *
     * @param string|null $title Title of the group. If not set, the group title will be used
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body Invite message with link. Example: \"Follow this link to join my group on WhatsApp\". Use %URL% to insert the invite link.
     *
     * @return self
     */
     ...
     * Sets preview_type
     *
     * @param string|null $preview_type Type of the group preview. Use 'group_picture' to set a group picture as large preview, 'thumbnail' to set a custom small jpeg image from 'preview' param as preview,  'media' to set a custom large image from 'media' param as large preview,  'style1' to set a isometric style for group invite link preview stub, 'style2' to set a flat style for group invite link preview stub, 'style3' to set a WA style for group invite link preview stub, or 'none' to not set a preview. If not set, the default is group_picture.
     *
     * @return self
     */
     ...
     * Sets preview
     *
     * @param string|null $preview Base64 encoded image for small version group invite link preview (preview_type=thumbnail). In JPEG format
     *
     * @return self
     */
