 ...
 */
class QR implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QR';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rowdata', $data ?? [], null);
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Status of the QR code
     *
     * @return self
     */
     ...
     * Sets base64
     *
     * @param string|null $base64 Base64 encoded QR code
     *
     * @return self
     */
    ...
    {
        return $this->container['rowdata'];
    }

    /**
     * Sets rowdata
     *
     * @param string|null $rowdata Rowdata for generating the QR code
     *
     * @return self
     */
    ...
    {
        if (is_null($rowdata)) {
            throw new \InvalidArgumentException('non-nullable rowdata cannot be null');
        }
        $this->container['rowdata'] = $rowdata;
     ...
     * Sets expire
     *
     * @param float|null $expire Seconds until the QR code expires
     *
     * @return self
     */
