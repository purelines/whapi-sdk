...
class MessageContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'sections' => '\OpenAPI\Client\Model\ActionListSectionsInner[]',
        'button' => 'string',
        'view_once' => 'bool',
        'id' => 'string',
        'link' => 'string',
        ...
        'time_offset' => 'float',
        'vcard' => 'string',
        'list' => '\OpenAPI\Client\Model\VCard[]',
        ...
        'vote_limit' => 'int',
        'total' => 'int',
        'results' => '\OpenAPI\Client\Model\PollResults[]',
        'list_reply' => '\OpenAPI\Client\Model\ListReply',
        'buttons_reply' => '\OpenAPI\Client\Model\ButtonsReply'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['invite_code']) && !preg_match("/^[A-Za-z0-9]{22}$/", $this->container['invite_code'])) {
            $invalidProperties[] = "invalid value for 'invite_code', must be conform to the pattern /^[A-Za-z0-9]{22}$/.";
        }
     ...
     * Gets body
     *
     * @return \OpenAPI\Client\Model\MessagePropsInteractiveBody
     */
     ...
     * Sets body
     *
     * @param \OpenAPI\Client\Model\MessagePropsInteractiveBody $body body
     *
     * @return self
     */
     ...
     * Gets sections
     *
     * @return \OpenAPI\Client\Model\ActionListSectionsInner[]|null
     */
     ...
     * Sets sections
     *
     * @param \OpenAPI\Client\Model\ActionListSectionsInner[]|null $sections Section of the message
     *
     * @return self
     */
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]+-[0-9a-fA-F-]+$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling MessageContent., must conform to the pattern /^[a-zA-Z0-9]+-[0-9a-fA-F-]+$/.");
        }
    ...
    public function setInviteCode($invite_code)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9]{22}$/", ObjectSerializer::toString($invite_code)))) {
            throw new \InvalidArgumentException("invalid value for \$invite_code when calling MessageContent., must conform to the pattern /^[A-Za-z0-9]{22}$/.");
        }
     ...
     * Gets list
     *
     * @return \OpenAPI\Client\Model\VCard[]|null
     */
     ...
     * Sets list
     *
     * @param \OpenAPI\Client\Model\VCard[]|null $list list
     *
     * @return self
     */
     ...
     * Gets results
     *
     * @return \OpenAPI\Client\Model\PollResults[]|null
     */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\PollResults[]|null $results results
     *
     * @return self
     */
     ...
     * Gets list_reply
     *
     * @return \OpenAPI\Client\Model\ListReply|null
     */
     ...
     * Sets list_reply
     *
     * @param \OpenAPI\Client\Model\ListReply|null $list_reply list_reply
     *
     * @return self
     */
     ...
     * Gets buttons_reply
     *
     * @return \OpenAPI\Client\Model\ButtonsReply|null
     */
     ...
     * Sets buttons_reply
     *
     * @param \OpenAPI\Client\Model\ButtonsReply|null $buttons_reply buttons_reply
     *
     * @return self
     */
