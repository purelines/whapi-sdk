...
class Webhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'url' => 'string',
        'mode' => 'string',
        'events' => '\Purelines\WhapiSdk\Model\Event[]',
    ];
    ...
    public const MODE_METHOD = 'method';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mode', $data ?? [], 'body');
    ...
    */
     ...
     * Sets headers
     *
     * @param array<string,string>|null $headers Additional headers for webhook. Max 5 headers. <br/>Example: <br/>\"Authorization - Bearer token\" <br/>\"Content-Type - application/json\" <br/>\"X-Header - value\"
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url Inbound and outbound notifications are routed to this URL.
     *
     * @return self
     */
     ...
     * Sets mode
     *
     * @param string|null $mode Request method for sending hook.
     *
     * @return self
     */
