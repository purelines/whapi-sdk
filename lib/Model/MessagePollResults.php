...
/**
 * MessagePollResults Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagePollResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagePollResults';
    ...
    */
    ...
    public function setOptions($options)
    {
        ...
        if ((count($options) > 12)) {
            throw new \InvalidArgumentException('invalid value for $options when calling MessagePollResults., number of items must be less than or equal to 12.');
        }
        if ((count($options) < 2)) {
            throw new \InvalidArgumentException('invalid length for $options when calling MessagePollResults., number of items must be greater than or equal to 2.');
        }
