    ...
    */
    ...
    public function setChatId($chat_id)
    {
        ...
        if ((!preg_match("/^[\\d-]{10,31}@[\\w\\.]{1,}$/", ObjectSerializer::toString($chat_id)))) {
            throw new \InvalidArgumentException("invalid value for \$chat_id when calling GroupApplication., must conform to the pattern /^[\\d-]{10,31}@[\\w\\.]{1,}$/.");
        }
     ...
     * Sets request_method
     *
     * @param string|null $request_method Application request method
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param float|null $timestamp Application creation time
     *
     * @return self
     */
