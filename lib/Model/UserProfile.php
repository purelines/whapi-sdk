...
class UserProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('icon_full', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets about
     *
     * @param string|null $about User info in About section.
     *
     * @return self
     */
     ...
     * Sets icon
     *
     * @param string|null $icon Profile preview icon url.
     *
     * @return self
     */
    ...
    {
        return $this->container['icon_full'];
    }

    /**
     * Sets icon_full
     *
     * @param string|null $icon_full Profile avatar url.
     *
     * @return self
     */
    public function setIconFull($icon_full)
    {
        if (is_null($icon_full)) {
            throw new \InvalidArgumentException('non-nullable icon_full cannot be null');
        }
        $this->container['icon_full'] = $icon_full;
