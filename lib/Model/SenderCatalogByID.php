...
/**
 * SenderCatalogByID Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SenderCatalogByID implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SenderCatalogByID';
    ...
    public const PREVIEW_TYPE_PRODUCT = 'product';
    public const PREVIEW_TYPE_BUSINESS_PROFILE = 'business_profile';
    ...
    {
        return [
            self::PREVIEW_TYPE_PRODUCT,
            self::PREVIEW_TYPE_BUSINESS_PROFILE,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('preview_type', $data ?? [], 'product');
    ...
    */
    ...
    public function setTo($to)
    {
        ...
        if ((!preg_match("/^[\\d-]{10,31}(@[\\w\\.]{1,})?$/", ObjectSerializer::toString($to)))) {
            throw new \InvalidArgumentException("invalid value for \$to when calling SenderCatalogByID., must conform to the pattern /^[\\d-]{10,31}(@[\\w\\.]{1,})?$/.");
        }
    ...
    public function setQuoted($quoted)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9._]{4,23}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{4,10})?$/", ObjectSerializer::toString($quoted)))) {
            throw new \InvalidArgumentException("invalid value for \$quoted when calling SenderCatalogByID., must conform to the pattern /^[A-Za-z0-9._]{4,23}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{4,10})?$/.");
        }
    ...
    public function setEphemeral($ephemeral)
    {
        ...
        if (($ephemeral > 604800)) {
            throw new \InvalidArgumentException('invalid value for $ephemeral when calling SenderCatalogByID., must be smaller than or equal to 604800.');
        }
        if (($ephemeral < 1)) {
            throw new \InvalidArgumentException('invalid value for $ephemeral when calling SenderCatalogByID., must be bigger than or equal to 1.');
        }
    ...
    public function setEdit($edit)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9._]{4,23}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{4,10})?$/", ObjectSerializer::toString($edit)))) {
            throw new \InvalidArgumentException("invalid value for \$edit when calling SenderCatalogByID., must conform to the pattern /^[A-Za-z0-9._]{4,23}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{4,10})?$/.");
        }
     ...
     * Sets title
     *
     * @param string|null $title Title of the catalog (if not set, the business name will be used)
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the catalog
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body Message text with link. Example: \"Follow this link to view our catalog on WhatsApp\". Use %URL% to insert the catalog link.
     *
     * @return self
     */
     ...
     * Sets preview
     *
     * @param string|null $preview Base64 encoded image for small version catalog preview (preview_type=thumbnail). In JPEG format
     *
     * @return self
     */
