    ...
    */
    ...
    public function setTo($to)
    {
        ...
        if ((!preg_match("/^[\\d-]{9,31}(@[\\w\\.]{1,})?$/", ObjectSerializer::toString($to)))) {
            throw new \InvalidArgumentException("invalid value for \$to when calling SenderCatalogByID., must conform to the pattern /^[\\d-]{9,31}(@[\\w\\.]{1,})?$/.");
        }
    ...
    public function setQuoted($quoted)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9._]{4,30}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{2,10})?$/", ObjectSerializer::toString($quoted)))) {
            throw new \InvalidArgumentException("invalid value for \$quoted when calling SenderCatalogByID., must conform to the pattern /^[A-Za-z0-9._]{4,30}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{2,10})?$/.");
        }
    ...
    public function setEdit($edit)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9._]{4,30}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{2,10})?$/", ObjectSerializer::toString($edit)))) {
            throw new \InvalidArgumentException("invalid value for \$edit when calling SenderCatalogByID., must conform to the pattern /^[A-Za-z0-9._]{4,30}-[A-Za-z0-9._]{4,14}(-[A-Za-z0-9._]{4,10})?(-[A-Za-z0-9._]{2,10})?$/.");
        }
