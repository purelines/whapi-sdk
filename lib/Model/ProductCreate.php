...
class ProductCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setImages($images)
    {
        ...
        if ((count($images) > 10)) {
            throw new \InvalidArgumentException('invalid value for $images when calling ProductCreate., number of items must be less than or equal to 10.');
        }
        if ((count($images) < 1)) {
            throw new \InvalidArgumentException('invalid length for $images when calling ProductCreate., number of items must be greater than or equal to 1.');
        }
    ...
    public function setPrice($price)
    {
        ...
        if (($price < 0)) {
            throw new \InvalidArgumentException('invalid value for $price when calling ProductCreate., must be bigger than or equal to 0.');
        }
