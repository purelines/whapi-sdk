...
class BusinessHours implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MODE_OPEN_24H = 'open_24h';
    public const MODE_SPECIFIC_HOURS = 'specific_hours';
    ...
    */
     ...
     * Sets mode
     *
     * @param string|null $mode Mode of working hours. You can not combine both
     *
     * @return self
     */
     ...
     * Sets open_time
     *
     * @param float|null $open_time Representation on hour in minutes. I.e 9 A.M. - 540
     *
     * @return self
     */
     ...
     * Sets close_time
     *
     * @param float|null $close_time Representation on hour in minutes. I.e 16 - 960
     *
     * @return self
     */
