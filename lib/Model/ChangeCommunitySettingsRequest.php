...
/**
 * ChangeCommunitySettingsRequest Class Doc Comment
 *
 * @category Class
 * @package  Purelines\WhapiSdk
 * @author   OpenAPI Generator team
 ...
 */
class ChangeCommunitySettingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChangeCommunitySettingsRequest';
    ...
    public const SETTING_MODIFY_GROUPS = 'modify_groups';
    public const SETTING_MEMBER_ADD_MODE = 'member_add_mode';
    ...
    {
        return [
            self::SETTING_MODIFY_GROUPS,
            self::SETTING_MEMBER_ADD_MODE,
        ];
    }
