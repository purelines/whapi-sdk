...
/**
 * MessagePropsVoice Class Doc Comment
 *
 * @category Class
 * @package  Purelines\WhapiSdk
 * @author   OpenAPI Generator team
 ...
 */
class MessagePropsVoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagePropsVoice';
    ...
    */
    ...
    public function setRecordingTime($recording_time)
    {
        ...
        if (($recording_time < 0)) {
            throw new \InvalidArgumentException('invalid value for $recording_time when calling MessagePropsVoice., must be bigger than or equal to 0.');
        }
