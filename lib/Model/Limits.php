...
class Limits implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets messages
     *
     * @param int $messages Maximum number of messages that can be sent
     *
     * @return self
     */
     ...
     * Sets chats
     *
     * @param string[] $chats List of chat IDs that can be used
     *
     * @return self
     */
     ...
     * Sets checks
     *
     * @param int $checks Maximum number of check phone numbers
     *
     * @return self
     */
     ...
     * Sets requests
     *
     * @param int $requests Maximum number of channel requests
     *
     * @return self
     */
