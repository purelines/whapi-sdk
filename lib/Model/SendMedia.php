...
/**
 * SendMedia Class Doc Comment
 *
 * @category Class
 * @description Media file to send. You can use preuploaded file or upload file on the fly.  Use preupload files if you want to send same file to multiple chats and so as not to disturb the order of messages.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SendMedia implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendMedia';
